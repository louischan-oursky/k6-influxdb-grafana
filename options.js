...
if (test_run_id == null || test_run_id === "") {
  throw new Error("TEST_RUN_ID must be defined");
}
...
export const options = {
  scenarios: {
    my_web_test: {
      ...
      tags: { test_type: "website", test_run_id }, // extra tags for the metrics generated by this scenario
    ...
    my_api_test_1: {
      ...
      tags: { test_type: "api", test_run_id }, // different extra metric tags for this scenario
    ...
    my_error_test: {
      ...
      duration,
      gracefulStop: "0s", // do not wait for iterations to finish in the end
      tags: { test_type: "error_test", test_run_id }, // extra tags for the metrics generated by this scenario
